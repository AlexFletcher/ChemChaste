#ifndef INHOMOGENOUSODESCHNACKENBERGCOUPLEDPDEODESYSTEM_HPP_
#define INHOMOGENOUSODESCHNACKENBERGCOUPLEDPDEODESYSTEM_HPP_
...
public:
     ...
     */
    InhomogenousOdeSchnackenbergCoupledPdeOdeSystem(double kappa1=1.0,
                                        double kappa_1=1.0,
                                        double kappa2=1.0,
                                        double kappa3=1.0)
        : AbstractInhomogenousOdeSystemForCoupledPdeSystem(2,3),
          ...
          mKappa3(kappa3)
    {
        mpSystemInfo = OdeSystemInformation<InhomogenousOdeSchnackenbergCoupledPdeOdeSystem>::Instance();
...
template<>
void OdeSystemInformation<InhomogenousOdeSchnackenbergCoupledPdeOdeSystem>::Initialise()
{
