#ifndef LINEARPARABOLICSCHNACKENBERGPDE_HPP_
#define LINEARPARABOLICSCHNACKENBERGPDE_HPP_
...
public:
    ...
    LinearParabolicSchnackenbergPde(
...
#endif /* LINEARPARABOLICSCHNACKENBERGPDE_HPP_ */
