#ifndef LINEARPARABOLICSCHNACKENBERGNONDIMPDE_HPP_
#define LINEARPARABOLICSCHNACKENBERGNONDIMPDE_HPP_
...
class LinearParabolicSchnackenbergNonDimPde : public AbstractLinearParabolicPdeSystemForCoupledOdeSystem<ELEMENT_DIM, SPACE_DIM, PROBLEM_DIM>
{
private:
...
public:
    ...
    LinearParabolicSchnackenbergNonDimPde(std::vector<double> diffusionRates,
                                          double k1,
                                          double k_1,
                                          double k2,
                                          double k3)
