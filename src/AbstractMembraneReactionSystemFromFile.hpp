...
public:
    ...
    AbstractMembraneReactionSystemFromFile(std::string);

    virtual ~AbstractMembraneReactionSystemFromFile()
    {
    };
...
void AbstractMembraneReactionSystemFromFile::FormReactionSystemObjectFromTuple(std::vector<std::tuple<std::string, bool, std::vector<std::string>, std::vector<std::string>, std::vector<unsigned>, std::vector<unsigned>, std::string>> system)
{
...
void AbstractMembraneReactionSystemFromFile::ParseSystemChemistry(std::vector<std::string> bulk_names, std::vector<std::string> cell_names)
{
...
std::vector<std::tuple<std::string, bool, std::vector<std::string>, std::vector<std::string>, std::vector<unsigned>, std::vector<unsigned>, std::string>> AbstractMembraneReactionSystemFromFile::ReactionSystemFromFile()
{
            ...
            if (!line.empty())
            {
                if (line.at(0) != '#')
                {
                    ...
                    if (coupled_reactions_delimiter_loc != std::string::npos)
                    {
                        ...
                        // second reaction substring
                        std::string second_reaction = line.substr(coupled_reactions_delimiter_loc+mReactionDelimiter.size(),std::string::npos);

                        // erase the second reaction string
                        line.erase(coupled_reactions_delimiter_loc, std::string::npos);
                        // first reaction substring
                        std::string first_reaction = line.substr(separate_point_type_reaction+3,std::string::npos);
...
bool AbstractMembraneReactionSystemFromFile::TestReversibility(std::string line)
{
    // test for reversibility in reaction string
...
std::tuple<std::vector<std::vector<std::string>>, std::vector<std::vector<unsigned>>> AbstractMembraneReactionSystemFromFile::ParseReactionString(std::string line)
{
...
std::tuple<std::vector<std::vector<std::string>>, std::vector<std::vector<unsigned>>> AbstractMembraneReactionSystemFromFile::AddCoupledReactions(std::tuple<std::vector<std::vector<std::string>>, std::vector<std::vector<unsigned>>> FirstReactionStringTuple, std::tuple<std::vector<std::vector<std::string>>, std::vector<std::vector<unsigned>>> SecondReactionStringTuple)
{
...
std::string AbstractMembraneReactionSystemFromFile::GetFileName()
{
