...
public:
     ...
     * Constructor.
     *
     * @param numStateVariables  the number of state variables in the ODE system (defaults to 0)
     * @param pdeSolutionSize  the size of the PDE solution at a point in space (defaults to 0)
     */
    AbstractInhomogenousOdeSystem(unsigned numStateVariables = 0,
    ...
    {
        return mpStateVariableRegister->GetNumStateVariables();
    }
};
