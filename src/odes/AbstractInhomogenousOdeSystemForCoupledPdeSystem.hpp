...
public:
    ...
    AbstractInhomogenousOdeSystemForCoupledPdeSystem(   unsigned numStateVariables = 0,
                                                        unsigned pdeSolutionSize = 0
                                                    )
        : AbstractOdeSystemForCoupledPdeSystem(numStateVariables,pdeSolutionSize)
    {
    ...
    void SetDomainStateVariableRegister(StateVariableRegister* p_domainStateVaribleRegister)
    {
        ...
        mPdeSolutionSize = p_domainStateVaribleRegister->GetNumStateVariables();
    }
